...
base_label_path = 'D:/ocr_share/various_shape_OCR/Training/label_form/'
base_image_path ='D:/ocr_share/various_shape_OCR/Training/image_form/'



labeling_f = open('C:/Users/user/Desktop/test/label.txt', 'w', encoding='utf-8')
count = 0
...
for q in os.listdir(base_label_path):
    ...
    for w in os.listdir(base_label_path + num_folder):
        ...
        # 이미지의 한 단어 가져오기
            ...
            img = cv2.imread('D:/ocr_share/various_shape_OCR/Training/image_form/'+num_folder+'/'+labeling,0)
            ...
            cv2.imwrite('D:/ocr_share/various_shape_OCR(crop)/' + labeling[:-4] + '_'+ str(count)+'.jpg', crop_img)

            labeling_f.write('D:/ocr_share/various_shape_OCR(crop)/' + labeling[:-4] + '_' +str(count)+'.jpg' +'\t' + value +'\n')
